...
class InputEvent(Event):
    ...
    def __init__(self, unicodechar, mouse_pos, mouse_buttons):
        self.name = "Input event"
        self.char = unicodechar
        self.mouse_pos = mouse_pos
        self.mouse_buttons = mouse_buttons
    def __str__(self):
        return '%s, char=%s, mouse_pos=%s, mouse_buttons=%s' % (self.name, self.char, self.mouse_pos, self.mouse_buttons)
